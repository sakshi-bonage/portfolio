...
Widget buildFooter(bool isMobile, {required ScrollController scrollController}) {
        ...
        ? Column(
            ...
            children: [
              ...
              OutlinedButton.icon(
                ...
                label: const Text("BACK TO TOP", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold)),
...
class _HoverBounceIconState extends State<_HoverBounceIcon> with SingleTickerProviderStateMixin {
