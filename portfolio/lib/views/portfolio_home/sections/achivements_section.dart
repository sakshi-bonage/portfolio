...
Widget achievementsSection(bool isMobile, {required GlobalKey key}) {
  return Container(
    key: key,
    ...
    child: Column(
      ...
      children: [
        ...
        // Fully Responsive Safe Layout System
        if (isMobile)
          Column(
            children: const [
              _Achievement3DCard(
...
class _Achievement3DCardState extends State<_Achievement3DCard> {
  ...
  void _updateGestureOffset(PointerEvent details, Size size) {
    ...
    setState(() {
      // Dynamic tilt adjustment coefficients
      ...
      builder: (context, constraints) {
        ...
        return MouseRegion(
          ...
          child: AnimatedContainer(
            ...
            // Performs complex structural matrix modifications
